...
import AppGateway.LoanClientAppGateway;
...
public class LoanClientFrame extends JFrame {
	...
	private LoanClientAppGateway loanBrokerAppGateway;
	...
	public LoanClientFrame() {
		...
		loanBrokerAppGateway = new LoanClientAppGateway(){

			@Override
			public void onLoanReplyArrived(LoanReply reply){

				showRequestReply(reply);
